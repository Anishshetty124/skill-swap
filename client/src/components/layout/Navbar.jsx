...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      <Link
        to="/"
        className="block py-2 md:py-0 text-slate-600 dark:text-slate-300 hover:text-blue-500"
      ...
      {isAuthenticated ? (
        <>
          ...
          <button
            ...
            className="w-full md:w-auto text-center py-2 md:py-2 md:px-4 bg-red-500 text-white rounded-md hover:bg-red-600"
          >
            Logout
          </button>
        </>
        ...
        <>
          ...
          <Link
            to="/register"
            className="block py-2 md:py-0 text-slate-600 dark:text-slate-300 hover:text-blue-500 font-semibold"
            onClick={() => setIsMenuOpen(false)}
          >
            Register
          </Link>
        ...
        <nav className="py-4 flex justify-between items-center">
          <Link to="/" className="flex items-center gap-2">
            <svg
              ...
              fill="currentColor"
            >
              <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2m4.69 6.31l-1.42 1.42a3 3 0 1 1-4.24-4.24L12.45 4a8 8 0 1 1-5.66 2.34l-1.42-1.42A10 10 0 1 0 16.69 8.31" />
              <path d="M12 22a10 10 0 0 0 7.07-2.93l-1.41-1.41A8 8 0 0 1 4.93 4.93l-1.41-1.41A10 10 0 0 0 12 22" />
            </svg>
            ...
            {isAuthenticated && user && (
              <Link to={`/profile/${user.username}`}>
                {user.profilePicture ? (
                  ...
                  <div className="h-12 w-12 rounded-full bg-purple-200 text-slate-800 dark:bg-purple-700 dark:text-slate-200 flex items-center justify-center font-bold text-2xl border-2 border-slate-300 dark:border-slate-600">
