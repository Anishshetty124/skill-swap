...
const SkillCard = ({ skill, hideUser = false }) => {
  ...
  // Correctly check if the user object and its _id exist before comparing
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        <div className="flex justify-between items-start mb-2">
          ...
          {/* This condition now correctly hides the button for the owner */}
        ...
        <div className="grid grid-cols-3 gap-4 text-center text-sm text-gray-500 dark:text-gray-400 mb-4">
          <div className="flex flex-col">
            <span className="font-bold text-lg text-amber-500">
              {skill.type === 'OFFER' ? skill.costInCredits : skill.creditsOffered}
            </span>
            <span className="text-xs">
              {skill.type === 'OFFER' ? 'Credits' : 'Credits Offered'}
            </span>
          </div>
          <div className="flex flex-col">
