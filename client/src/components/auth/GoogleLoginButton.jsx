...
const GoogleLoginButton = () => {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 py-3 font-semibold text-slate-700 bg-white border border-slate-300 rounded-lg shadow-sm hover:bg-slate-50 transition-all duration-300"
    >
