...
const EditProfilePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const accountData = { username, email };
        ...
        <div className="max-w-2xl mx-auto p-8 bg-white dark:bg-slate-800 rounded-lg shadow-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input type="text" placeholder="e.g., San Francisco, CA" value={locationString} onChange={(e) => setLocationString(e.target.value)} className="w-full px-3 py-2 mt-1 bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-200 border rounded-md"/>
            </div>
